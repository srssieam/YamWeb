    ...
    return (
        <div className=" md:my-11 px-6 lg:px-0 m-4 max-w-[1250px] mx-auto text-[#4c7c2d]">
            ...
            <div className='flex flex-wrap gap-9 my-6'>
                <div className='flex-1 border border-[#64a13b] p-11 text-center space-y-5 hover:bg-[#ffa600] cursor-pointer' data-aos="flip-left" data-aos-duration="1000">
                ...
                <div className='flex-1 border border-[#64a13b] p-11 text-center space-y-5 hover:bg-[#ffa600] cursor-pointer' data-aos="flip-up" data-aos-duration="1000">
                ...
                <div className='flex-1 border border-[#64a13b] p-11 text-center space-y-5 hover:bg-[#ffa600] cursor-pointer'  data-aos="flip-right" data-aos-duration="1000">
